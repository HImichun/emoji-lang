...
var app = (function () {
    ...
    // (13:3) {#each Emojis.grammar as emoji}
    function create_each_block_1(ctx) {
    	let button;
    	let t_value = /*emoji*/ ctx[12] + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[2](/*emoji*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "svelte-s6tz1s");
    			add_location(button, file$1, 13, 4, 334);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:3) {#each Emojis.grammar as emoji}",
    		ctx
    	});
    ...
    // (18:3) {#each Emojis[currentTab] as emoji}
    function create_each_block(ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[3](/*emoji*/ ctx[12]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "svelte-s6tz1s");
    			add_location(button, file$1, 18, 4, 479);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*currentTab*/ 1 && t_value !== (t_value = /*emoji*/ ctx[12] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(button);
    			mounted = false;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:3) {#each Emojis[currentTab] as emoji}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "grammar svelte-s6tz1s");
    			add_location(div0, file$1, 11, 2, 273);
    			attr_dev(div1, "class", "list svelte-s6tz1s");
    			add_location(div1, file$1, 16, 2, 417);
    			attr_dev(button0, "class", "svelte-s6tz1s");
    			add_location(button0, file$1, 22, 3, 584);
    			attr_dev(button1, "class", "svelte-s6tz1s");
    			add_location(button1, file$1, 23, 3, 641);
    			attr_dev(button2, "class", "svelte-s6tz1s");
    			add_location(button2, file$1, 24, 3, 701);
    			attr_dev(button3, "class", "svelte-s6tz1s");
    			add_location(button3, file$1, 25, 3, 761);
    			attr_dev(button4, "class", "svelte-s6tz1s");
    			add_location(button4, file$1, 26, 3, 819);
    			attr_dev(button5, "class", "svelte-s6tz1s");
    			add_location(button5, file$1, 27, 3, 879);
    			attr_dev(button6, "class", "svelte-s6tz1s");
    			add_location(button6, file$1, 28, 3, 937);
    			attr_dev(div2, "class", "tabs svelte-s6tz1s");
    			add_location(div2, file$1, 21, 2, 562);
    			attr_dev(div3, "class", "pallete svelte-s6tz1s");
    			add_location(div3, file$1, 10, 1, 249);
    			add_location(main, file$1, 9, 0, 241);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*click_handler_2*/ ctx[4], false, false, false),
    					listen_dev(button1, "click", /*click_handler_3*/ ctx[5], false, false, false),
    					listen_dev(button2, "click", /*click_handler_4*/ ctx[6], false, false, false),
    					listen_dev(button3, "click", /*click_handler_5*/ ctx[7], false, false, false),
    					listen_dev(button4, "click", /*click_handler_6*/ ctx[8], false, false, false),
    					listen_dev(button5, "click", /*click_handler_7*/ ctx[9], false, false, false),
    					listen_dev(button6, "click", /*click_handler_8*/ ctx[10], false, false, false)
    				];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file, 29, 1, 1301);
    			add_location(main, file, 28, 0, 1293);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [inputField, text, handleEmojiInput, textarea_binding, textarea_input_handler];
    }
